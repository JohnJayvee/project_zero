...
<ul class="nav nav-tabs">
						...
						<li class="active"><a href="<?= base_url() ?>alumni_student.php"><span class="hidden-tablet"> Alumni Students</span></a></li>
			...
			<div class="box-content">
				...
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
				  ...
				  <?php 
						...
						$user_data = get_alumni_join($table_name,'section','section_id');
						...
						//$studid = get_studid_from_id(id)
				  		$edit_user_url = base_url().'student_archive_conf.php?id='.$id;
				  		$student_url = base_url().'student_profile_proc.php?id='.$id;
				  ...
				  ?>
					<tr>
						...
						<td class="center" class="span3">
							
							<a class="btn btn-success" href="student_profile.php?id=<?= $studid ?>">View Profile </a>
							<!--<a class="btn btn-primary" href="student_edit.php?id=<?= $id ?>">Promote</a>
							<a class="btn btn-danger" href="student_archive_conf.php?id=<?= $id ?>">Alumni </a>
