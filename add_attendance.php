                          ...
                          ?>
							...
							<tr>
								<td class="center">
									...
									<input type="checkbox" name="attendance_status[]" value="<?= $id ?>">
								</td>
								</td>
								<td class="center">
									<?= $serialnumber ?>
								...
								<td class="center">
									<?= $fname ?><input type="hidden" value="<?= $fname ?>" name="fname">
								</td>
								<td class="center">
									<?= $lname ?><input type="hidden" value="<?= $lname ?>" name="lname">
								</td>
								<td class="center">
									<?= $gender ?><input type="hidden" value="<?= $gender ?>" name="gender">
								</td>
								<td class="center">
									<?= $section ?><input type="hidden" value="<?= $section ?>" name="section">
								</td>
								<td class="center">
									<?= $strand ?><input type="hidden" value="<?= $strand ?>" name="strand">
								</td>
