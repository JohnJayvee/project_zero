...
<ul class="nav nav-tabs">
<li ><a href="<?= base_url() ?>view_late.php"><span class="hidden-tablet">Today</span></a></li>				
<li class="active"><a href="<?= base_url() ?>view_all_late.php"><span class="hidden-tablet">All Time</span></a></li>
			...
			<div class="box-content">
				...
				<?php
				session_start();
				 $user_data = get_join_all_attendance('students', 'attendance_records','studid',2,$_SESSION["sname"]);;
