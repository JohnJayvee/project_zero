...
?>
	<ul class="nav nav-tabs">
		<li class="active"><a href="student_profile.php?=<?= $_SESSION['studid'] ?>"><span
					class="hidden-tablet">Profile</span></a></li>
		<li><a href="student_profile_present.php?=<?= $_SESSION['studid'] ?>"><span
					class="hidden-tablet">Present</span></a></li>
		<li><a href="student_profile_late.php?=<?= $_SESSION['studid'] ?>"><span class="hidden-tablet">Late</span></a>
		</li>
