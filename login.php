					...
					<form class="form-horizontal" action="<?= base_url() ?>login_proc.php" method="post">
						<fieldset>
							...
							<div class="input-prepend" title="Username">
								...
								<input class="input-large span10" name="username" type="text"
									placeholder="type username" autocomplete="off" required />
							</div>
							...
							<div class="input-prepend" title="Password">
								...
								<input class="input-large span10" name="password" type="password"
									placeholder="type password" autocomplete="off" required />
							</div>
							<div class="clearfix"></div>
