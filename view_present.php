...
<li class="active"><a href="<?= base_url() ?>view_present.php"><span class="hidden-tablet">Present</span></a></li>
...
<li><a href="<?= base_url() ?>view_absent.php"><span class="hidden-tablet">absent</span></a></li>
	...
	<div class="box-content">
				...
				<?php
				session_start();
				 $user_data = get_join_attendance('students', 'attendance_records','studid',1,$_SESSION["sname"]);;
