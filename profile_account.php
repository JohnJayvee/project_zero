		...
		<div class="container-fluid">
				...
				<div class="col-lg-4">
					...
					<div class="card-body">
						<table class="table	table-bordered">
							<tr>
								<td colspan="2">
									<center><img src="<?php echo $user_avatar; ?>" class="img-responsive" alt="prof-pic"
											width="50%;"></center>
								</td>
							</tr>
							<tr>
            ...
            if (($_SERVER["REQUEST_METHOD"] == "POST") && (isset($_POST['save']) == "Update")) {
	            ...
	            if (empty($_POST['oldPass'])) {
		            $oldPassErr = "Old password should not be blank";
		            $x = 1;
	            } else {
	            ...
	            if (empty($_POST['cEmail'])) {
		            $cEmailErr = "Email address should not be blank";
		            $x = 1;
	            } else {
	            ...
	            if (empty($_POST['newPass'])) {
		            $newPassErr = "New password should not be blank";
		            $x = 1;
	            } else {
	            ...
	            if (empty($_POST['cnewPass'])) {
		            $cnewPassErr = "Your must confirm your new password";
		            $x = 1;
	            } else {
	            ...
	            if ($count == 0) {
		            ...
		            // UPDATE DATA
            		$sql_update = "UPDATE users SET password='$newpp' WHERE username='$uname' AND id = '$id'";
            ...
            ?>
						<form name="frmUploadFile" method="post"
							action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" role="form"
							enctype="multipart/form-data" onsubmit="return checkForm(this);" autocomplete="off">
							<div class="form-group">
								<div class="form-row">
									<div class="col-md-6">
										<label for="oldPass">Old Password<span class="error"> *
												<?php echo $oldPassErr; ?>
											</span></label>
										<input class="form-control" type="password" aria-describedby="oldPass"
											placeholder="Enter Old Password" name="oldPass"
											value="<?php echo $oldPass; ?>" pattern=".{5,20}"
											title="Please enter 5 to 20 characters" required autofocus>
									</div>
									<div class="col-md-6">
										<label for="cEmail">Email Address<span class="error"> *
												<?php echo $cEmailErr; ?>
											</span></label>
										<input class="form-control" type="email" aria-describedby="cEmail"
											placeholder="Enter your email address " name="cEmail"
							...
							<div class="form-group">
								<div class="form-row">
									<div class="col-md-6">
										<label for="newPass">New Password<span class="error"> *
												<?php echo $newPassErr; ?>
											</span></label>
										<input class="form-control" type="password" aria-describedby="newPass"
											placeholder="Enter New Password" name="newPass"
											value="<?php echo $newPass; ?>" pattern=".{5,20}"
											title="Please enter 5 to 20 characters" required>
									</div>
									<div class="col-md-6">
										<label for="cnewPass">Confirm Password<span class="error"> *
												<?php echo $cnewPassErr; ?>
											</span></label>
										<input class="form-control" type="password" aria-describedby="cnewPass"
											placeholder="Confirm New Password" name="cnewPass"
											value="<?php echo $cnewPass; ?>" pattern=".{5,20}"
											title="Please enter 5 to 20 characters" required>
									</div>
								</div>
							</div>
