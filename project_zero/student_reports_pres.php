...
<ul class="nav nav-tabs">
						...
						<li class="active"><a href="<?= base_url() ?>student_manage.php"><span class="hidden-tablet">Absents Report</span></a></li>
      ...
      <div class="progress" style="text-align: center;">
        <span style=" position: absolute;margin-left: -50px;">
             <?= $no_pres ?> Present ( <?= (round($percentage,2)) ?>% )</span>
      <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="30" aria-valuemin="30" aria-valuemax="100" style="width:<?= $percentage ?>%;">
      </div> 
      </div> 
</td>
</tr>
