...
<ul class="nav nav-tabs">
						...
						<li class="active"><a href="<?= base_url() ?>student_create.php"><span class="hidden-tablet"> Add Student</span></a></li>
			...
			<div class="box-content">
				...
				<fieldset>
					<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="form-control" name="studid" required style="width: 40%;" autocomplete="off" placeholder="Enter Student ID">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">First Name:</label>
							<div class="controls">
								<input type="text" class="form-control" name="fname" required style="width: 40%;" autocomplete="off" placeholder="Enter First Name">
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">Middle Name:</label>
							<div class="controls">
								<input type="text" class="form-control" name="mname" required style="width: 40%;" placeholder="Enter Middle Name">
							</div>
						</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="form-control" name="lname" required style="width: 40%;" placeholder="Enter Last Name">
							</div>
						</div>
						<div class="control-group">
						...
						<div class="form-actions">
							<button type="submit" class="btn btn-primary btn-lg" name="submit" value="Submit">Add student</button>
