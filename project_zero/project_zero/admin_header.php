			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="<?= base_url() ?>add_shs.php"><span class="hidden-tablet"> Add Senior High School</span></a></li>
						<li><a href="<?= base_url() ?>attendance.php"><span class="hidden-tablet"> Check Attendance</span></a></li>
						<li><a href="<?= base_url() ?>view_attendance.php"><span class="hidden-tablet"> View Attendance</span></a></li>
						<?php
						}
						?>
