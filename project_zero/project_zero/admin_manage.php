...
<ul class="nav nav-tabs">
						...
						<li><a href="<?= base_url() ?>user_manage.php"><span class="hidden-tablet">All Users</span></a></li>
						
						<li><a href="<?= base_url() ?>super_admin.php"><span class="hidden-tablet">Super Admin</span></a></li>
						<li  class="active" ><a href="<?= base_url() ?>admin_manage.php"><span class="hidden-tablet">Admin</span></a></li>
						<li><a href="<?= base_url() ?>user_create.php"><span class="hidden-tablet"> Add</span></a></li>
