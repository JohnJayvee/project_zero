...
<ul class="nav nav-tabs">
						...
						<li><a href="<?= base_url() ?>male.php"><span class="hidden-tablet">Male</span></a></li>
						<li class="active"><a href="<?= base_url() ?>female.php"><span class="hidden-tablet">Female</span></a></li>
