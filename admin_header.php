					...
					<ul class="nav pull-right">
						...
						<li class="dropdown">
							<a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
								<i class="halflings-icon white user"></i> <?= _get_firstname_from_id($_SESSION['id']) ?>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						<li><a href="<?= base_url() ?>dashboard.php"><i class="icon-bar-chart"></i><span class="hidden-tablet"> REPORTS</span></a></li>
						<li><a href="#" data-toggle="modal" data-target="#exampleModal"><span class="hidden-tablet">Do Attendance</span></a></li>
						<li><a  href="<?= base_url() ?>attendance.php"><span class="hidden-tablet">Admission</span></a></li>
						<?php
						$acct_type = _get_accttype_from_id($_SESSION['id']);
						if ($acct_type==1){
						?>
						<li><a href="<?= base_url() ?>student_manage.php"><span class="hidden-tablet"> Students</span></a></li>
						<li><a href="<?= base_url() ?>strand_manage.php"><span class="hidden-tablet">Senior High School</span></a></li>
						...
						<li><a href="<?= base_url() ?>shs_report.php""><span class="hidden-tablet"> Senior High School Report</span></a></li>
