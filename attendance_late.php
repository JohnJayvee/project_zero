...
<li class="active"><a href="<?= base_url() ?>attendance_late.php"><span class="hidden-tablet">Late</span></a></li>
<li ><a href="<?= base_url() ?>reason_manage.php"><span class="hidden-tablet"> Reasons</span></a></li>
				...
				<?php
				 ...
				 $user_data = get_join_all_everything_attendance('students','attendance_records','studid',2);
