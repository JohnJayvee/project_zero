...
<?php
	...
	$form_location = base_url()."reason_edit_proc.php?id=".$id; 
	$table_name = "reasons";
	...
	<div class="row-fluid sortable">	
		<div class="box span12">
			<div class="box-header" data-original-title>
				<h2><i class="halflings-icon white file"></i><span class="break"></span>Reasons</h2>
			</div>
				...
				<form class="form-horizontal" method="post" action="<?= $form_location ?>">
					<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="span4" name="reasons" value="<?= $reasons ?>" required>
							</div>
						</div>
