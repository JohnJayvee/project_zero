...
<ul class="nav nav-tabs">
	...
	<li><a href="<?= base_url() ?>student_abm.php"><span class="hidden-tablet"> ABM</span></a></li>
	<li class="active"><a href="<?= base_url() ?>student_humss.php"><span class="hidden-tablet">HUMSS</span></a></li>
		...
		<div class="box span12">
			...
			<div class="box-content">
				...
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
                  ...
                  $user_data = get_where_custom($table_name, 'strand', 'HUMSS');
                  ...
                  ?>
						<tr>
							...
							<td class="center">
								...
								<a class="btn btn-primary" href="student_profile_proc.php?id=<?= $studid ?>">View
									Profile </a>
