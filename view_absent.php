...
<li  ><a href="<?= base_url() ?>view_all_absent.php"><span class="hidden-tablet">All Time</span></a></li>
				...
				<?php
				session_start();
				 $user_data = get_join_attendance('students', 'attendance_records','studid',3,$_SESSION["sname"]);
