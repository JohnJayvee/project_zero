			...
			<div class="box-content">
				...
				<form class="form-horizontal" method="post" action="<?= $form_location ?>">
					<fieldset>
						...
						<div class="controls">
							<select name="reason" autocomplete="off" required class="span4">
								...
								foreach ($result as $key => $row) {
									$reasons = $row['reasons'];
									?>
 								<option value="<?= $reasons ?>"><?php echo $reasons; ?></option>
									<?php
								}
						...
						<div class="control-group">
							<label class="control-label">Excuse?</label>
							<div class="controls">
								<input type="checkbox" name="excuse" value="5"> 
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">Whole Day?</label>
							<div class="controls">
								<input type="checkbox" name="attendance_day" value="5">
							</div>
						</div>
						...
						<div class="form-actions">
							...
							<a class="btn" href="view_absent.php">Cancel</a>
						</div>
